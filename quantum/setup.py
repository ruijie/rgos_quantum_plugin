...
rgos_plugin_config_path = 'etc/quantum/plugins/rgos'
...
DataFiles = [
    ...
    (rgos_plugin_config_path,
        ['etc/quantum/plugins/rgos/rgos_quantum_plugin.ini']),	
]
...
setuptools.setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'quantum-rgos-agent ='
            'quantum.plugins.rgos.agent.rgos_quantum_agent_ovs:main',
            'quantum-ryu-agent = '
